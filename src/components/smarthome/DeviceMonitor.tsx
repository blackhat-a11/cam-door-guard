...
export function DeviceMonitor({
  ...
  return (
    <div className="panel animate-fade-up space-y-3 p-5">
      ...
      <div className="rounded-xl border border-border bg-secondary/40 p-4 transition-transform duration-300 hover:-translate-y-0.5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span
              className={`size-3 rounded-full transition-colors ${online ? "bg-success pulse-ring" : "bg-muted-foreground"}`}
            />
            <div>
